...
solCount <- 1
# Load the solutions
solsList <- readMat("~/Documents/Morphorods/Code/MATLAB/MechanicalCoupling/TensionBasedGrowth/Solutions/sols_k0p04_L20_n3s_m0p95.mat")
...
gammaList <- readMat("~/Documents/Morphorods/Code/MATLAB/MechanicalCoupling/TensionBasedGrowth/Solutions/gamma_k0p04_L20_n3s_m0p95.mat")
...
# Tweaking the plots
solPlot <- solPlot + theme_classic()
gammaPlot <- gammaPlot + theme_classic() 
