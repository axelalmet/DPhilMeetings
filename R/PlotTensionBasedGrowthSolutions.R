...
# Load the solutions
solsList <- readMat("~/Documents/Morphorods/Code/MATLAB/MechanicalCoupling/TensionBasedGrowth/Solutions/sols_k0p04_L20_n3s0p6_mum1.mat")
...
gammaList <- readMat("~/Documents/Morphorods/Code/MATLAB/MechanicalCoupling/TensionBasedGrowth/Solutions/gamma_k0p04_L20_n3sm0p95_mu8.mat")
